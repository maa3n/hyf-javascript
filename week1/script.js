...
if (c===d){
	console.log( 'The variables c and d have the same type: '  + typeof c + typeof d )
} else {
	console.log( 'The variables c and d have a different type: '  + typeof c + typeof d  )
}

if (d===e){
	console.log( 'The variables d and e have the same type: '  + typeof d + typeof e )
} else {
	console.log( 'The variables d and e have a different type: '  + typeof d + typeof e  )
}


if (e===f){
	console.log( 'The variables e and f have the same type: '  + typeof e + typeof f )
} else {
	console.log( 'The variables e and f have a different type: '  + typeof e + typeof f  )
}


if (e===e){
	console.log( 'The variables e and e have the same type: '  + typeof e + typeof e )
} else {
	console.log( 'The variables e and e have a different type: '  + typeof e + typeof e  )
}


if (f===f){
	console.log( 'The variables f and f have the same type: '  + typeof f + typeof f )
} else {
	console.log( 'The variables f and f have a different type: '  + typeof f + typeof f  )
}
